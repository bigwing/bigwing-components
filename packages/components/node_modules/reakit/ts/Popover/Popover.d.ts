...
export declare const usePopover: {
    (options?: PopoverOptions | undefined, htmlProps?: import("..").BoxHTMLProps | undefined, unstable_ignoreUseOptions?: boolean | undefined): import("..").BoxHTMLProps;
    unstable_propsAreEqual: (prev: import("..").BoxOptions & Pick<Partial<import("..").DisclosureStateReturn>, "visible" | "baseId" | "animated" | "animating" | "stopAnimation"> & Pick<Partial<import("..").DialogStateReturn>, "hide" | "modal" | "unstable_disclosureRef"> & Pick<import("..").DialogStateReturn, "baseId"> & {
    ...
    }, next: import("..").BoxOptions & Pick<Partial<import("..").DisclosureStateReturn>, "visible" | "baseId" | "animated" | "animating" | "stopAnimation"> & Pick<Partial<import("..").DialogStateReturn>, "hide" | "modal" | "unstable_disclosureRef"> & Pick<import("..").DialogStateReturn, "baseId"> & {
        hideOnEsc?: boolean | undefined;
        hideOnClickOutside?: boolean | undefined;
        preventBodyScroll?: boolean | undefined;
        unstable_initialFocusRef?: import("react").RefObject<HTMLElement> | undefined;
