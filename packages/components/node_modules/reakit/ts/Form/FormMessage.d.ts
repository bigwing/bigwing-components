...
export declare const unstable_useFormMessage: <V, P extends DeepPath<V, P>>(options: unstable_FormMessageOptions<V, P>, htmlProps?: BoxHTMLProps | undefined) => unstable_FormMessageHTMLProps;
