...
export declare const unstable_useFormInput: <V, P extends DeepPath<V, P>>(options: unstable_FormInputOptions<V, P>, htmlProps?: InputHTMLProps | undefined) => unstable_FormInputHTMLProps;
